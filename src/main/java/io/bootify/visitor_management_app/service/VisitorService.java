...
public class VisitorService {
    ...
    private VisitorDTO mapToDTO(final Visitor visitor, final VisitorDTO visitorDTO) {
        ...
        visitorDTO.setAddressDTO(addressDTO);
        return visitorDTO;
    }
    ...
    private Visitor mapToEntity(final VisitorDTO visitorDTO, final Visitor visitor) {
        ...
        address.setLine1(visitorDTO.getAddressDTO().getLine1());
        address.setLine2(visitorDTO.getAddressDTO().getLine2());
        address.setCity(visitorDTO.getAddressDTO().getCity());
        address.setPincode(visitorDTO.getAddressDTO().getPincode());
        address.setCountry(visitorDTO.getAddressDTO().getCountry());
